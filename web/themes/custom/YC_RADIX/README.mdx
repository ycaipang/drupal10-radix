...
YC_RADIX theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of YC_RADIX theme and run the following commands:
`nvm use`
...
`drush en YC_RADIX -y`
`drush config-set system.theme default YC_RADIX -y`
